    ...
    def __init__(self, llm, domain_context, tools):
        ...
        prompt = ChatPromptTemplate.from_messages([
            ("system",
             ...
             "2) Thu thập phần còn thiếu theo thứ tự: Chi nhánh → {required_booking_fields} (chỉ hỏi khi thiếu).\n"
             "3) KHI ĐỦ 5 TRƯỜNG: Tên, SĐT, Chi nhánh, Ngày giờ, Số người → GỌI book_table_reservation NGAY (không cần hỏi thêm).\n"
