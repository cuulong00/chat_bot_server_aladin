    ...
    generation_prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                "- Hiển thị kết quả cũng phải có format đẹp:\n"
                "\n"
                "✅ **HOÀN TẤT ĐẶT BÀN**\n"
                "🎫 **Mã đặt bàn:** [ID nếu có]\n"
                "📋 **Chi tiết:** [Tóm tắt ngắn gọn]\n"
                "📞 **Bước tiếp theo:** [Lễ tân sẽ gọi xác nhận hoặc đã xác nhận thành công]\n"
                "\n"
