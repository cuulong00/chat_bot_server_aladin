    ...
    direct_answer_prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                "  • ❗️Không hỏi lại tên nếu đã biết. Nếu {user_info}.name có giá trị hoặc {conversation_summary} đã nêu tên, hãy dùng tên đó.\n"
                "    - Tự động tách họ/tên để điền vào tool: phần cuối là first_name; phần còn lại là last_name.\n"
