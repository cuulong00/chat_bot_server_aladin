...
# Ensure docker-compose exposes 2025:2024 (container listens on 2024)
if ! grep -q '"2025:2024"' docker-compose.yml; then
  warn "Make sure docker-compose.yml maps 2025:2024 under services.chatbot."
fi
