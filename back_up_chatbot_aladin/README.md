...
-->
uvicorn app:app --host 0.0.0.0 --port 2024 --reload
 
## Facebook Messenger Environment

Add these variables to your `.env` when enabling Facebook Messenger integration:

```
FB_PAGE_ACCESS_TOKEN=your_page_access_token
FB_APP_SECRET=your_app_secret
FB_VERIFY_TOKEN=choose_a_verify_token
